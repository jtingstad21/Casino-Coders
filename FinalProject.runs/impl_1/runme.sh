...
HD_PWD='Z:/CS-373-1/Final_Project/Casino-Coders/FinalProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ChangeHex.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ChangeHex.tcl -notrace
