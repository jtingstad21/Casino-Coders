...
HD_PWD='Z:/CS-373-1/Final_Project/Casino-Coders/FinalProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ChangeHex.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ChangeHex.tcl
